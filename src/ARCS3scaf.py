...
#
###################################################################
args = '-K %d -o %s -e %d -t 1 -F' % (config['kmer_size'], os.path.join(config['workspace'], 'kmers.arff'), config['READ_LENGTH_CUTOFF'])
...
#
###################################################################
args = '%s %s %s %s' % (config['workspace'], os.path.join(config['workspace'], 'cdbg_copy_number.fa'), os.path.join(config['workspace'], 'component_%d' % (len(config['library_list'])+1)), os.path.join(config['workspace'], 'component_%d' % (len(config['library_list'])+2)))
...
#
###################################################################
# notice that component_(i+1) not component_(i+2) resaon see youdao 22,June  in that way, above reverse_filter.py does not work
args = '-s %s -d %s -K %d -O %d -C %s -l %s -I %s -f %s' % (os.path.join(config['workspace'], 'scaffold_parameter_0'), config['workspace'], config['kmer_size'], 10, os.path.join(config['workspace'], 'cdbg_copy_number.fa'), os.path.join(config['workspace'], 'component_%d' % (len(config['library_list'])+1)), os.path.join(config['workspace'], 'condensed_de_bruijn_graph_before_trimming.data'), os.path.join(config['workspace'], 'scaf_seq_with_gaps'))

#args = '-s %s -d %s -K %d -O %d -C %s -l %s -I %s -f' % (os.path.join(config['workspace'], 'scaffold_parameter_0'), config['workspace'], config['kmer_size'], 10, os.path.join(config['workspace'], 'cdbg_copy_number.fa'), os.path.join(config['workspace'], 'component_last'), os.path.join(config['workspace'], 'condensed_de_bruijn_graph_before_trimming.data') )
...
###################################################################
#
# python giveComponentNumber.py
#
###################################################################

#args = '%s %s %s %s' % (os.path.join(config['workspace'], 'scaf_seq_with_gaps'), os.path.join(config['workspace'], 'contigs.fasta'), os.path.join(config['workspace'], 'contig_len'),os.path.join(config['workspace'], 'component_%d' % i))

args = '%s %s %s %s %s' % (os.path.join(config['workspace'], 'scaf_seq_with_gaps'), os.path.join(config['workspace'], 'contigs.fasta'), os.path.join(config['workspace'], 'contig_len'), os.path.join(config['workspace'], 'component_%d' % i), os.path.join(config['workspace'], 'sg_copy_number.fa'))
command_run('python', os.path.join(os.path.abspath(os.path.dirname(__file__)), 'giveComponentNumber.py'), args, config)
...
args = '%s %s %s %s %s %s %s %s' % (os.path.join(config['workspace'], 'contig_len'), os.path.join(config['workspace'], 'component_%d' % i), os.path.join(config['workspace'], 'blasrResult'), os.path.join(config['workspace'], 'contig_arc_graph_after_remove_ambigous_arcs_%d' % i), os.path.join(config['workspace'], 'position_lp_%d.math' % i), os.path.join(config['workspace'], 'edge_cluster_len_%d' % i), os.path.join(config['workspace'], 'parameter_%d' % (i)), os.path.join(config['workspace'], 'map_detail'))
...
#
###################################################################
args = '%s %s %s %s' % (config['workspace'], os.path.join(config['workspace'], 'sg_copy_number.fa'), os.path.join(config['workspace'], 'component_%d' % (i+1)), os.path.join(config['workspace'], 'component_%d' % (i+2)))

#args = '%s %s %s' % (config['workspace'], os.path.join(config['workspace'], '31mer.scaf_seq_with_gaps'), os.path.join(config['workspace'], 'component_%d' % (i+1)))
command_run('python', os.path.join(os.path.abspath(os.path.dirname(__file__)), 'reverse_filter.py'), args, config)
...
#
###################################################################
args = '%s %s %s %s %s' % (os.path.join(config['workspace'], 'component_%d' % (i+2)), os.path.join(config['workspace'], 'sg_copy_number.fa'), os.path.join(config['workspace'], 're_pacbio_read.fasta'), os.path.join(config['workspace'], 'map_detail'), os.path.join(config['workspace'], 'gap_filling_after_3rd'))
...
args = '-s %s -d %s -K %d -O %d -C %s -l %s -I %s -f %s' % (os.path.join(config['workspace'], 'scaffold_parameter_0'), config['workspace'], config['kmer_size'], config['kmer_size'] - 10, os.path.join(config['workspace'], 'sg_copy_number.fa'), os.path.join(config['workspace'], 'component_%d' % (i+2)), os.path.join(config['workspace'], 'condensed_de_bruijn_graph_before_trimming.data'), os.path.join(config['workspace'], 'scaf_after_3rd') )
